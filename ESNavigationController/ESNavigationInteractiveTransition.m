//
//  ESNavigationInteractiveTransition.m
...
@interface ESNavigationInteractiveTransition ()
@property (nonatomic, weak) UINavigationController *vc;
@property (nonatomic, strong) UIPercentDrivenInteractiveTransition *interactivePopTransition;
@end
@implementation ESNavigationInteractiveTransition
...
- (id<UIViewControllerAnimatedTransitioning>)navigationController:(UINavigationController *)navigationController
    ...
    if (operation == UINavigationControllerOperationPop)
        return [[ESPopAnimation alloc] init];
...
- (id<UIViewControllerInteractiveTransitioning>)navigationController:(UINavigationController *)navigationController
     ...
     */
    if ([animationController isKindOfClass:[ESPopAnimation class]])
